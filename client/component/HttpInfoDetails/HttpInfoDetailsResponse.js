        ...
        return (
            <div className='column is-12 box content is-small'>
                <div className='columns'>
                    ...
                    <div
                        className='column is-9 is-vertical-spaceless'>{this.props.response.status} {this.props.response.statusText}.
                        {this.props.response.httpVersion}</div>
                </div>
                <div className="columns">
                    <div className="column is-3 has-text-bold has-text-left is-vertical-spaceless">Response headers
                    </div>
                </div>
                <hr/>
                {
                    this.props.response.headers.map((header) => {
                        return (
                            <div className='columns'>
                                <div
                                    className='column is-3 has-text-right is-vertical-spaceless has-text-bold'>{header.name}</div>
